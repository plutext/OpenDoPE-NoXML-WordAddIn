...
{
    public partial class ControlDataTypeFlatOpcXml : UserControl
    {

        static Logger log = LogManager.GetLogger("ControlDataTypeFlatOpcXml");

        public ControlDataTypeFlatOpcXml()
        {
            InitializeComponent();
        }
